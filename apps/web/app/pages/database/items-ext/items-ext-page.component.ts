...
import { ItemTableExtAdapter } from '~/widgets/data/item-table/item-table-ext-adapter'
import { ItemTableRecord } from '~/widgets/data/item-table'
import { PriceImporterModule } from '~/widgets/price-importer/price-importer.module'
import { ScreenshotModule } from '~/widgets/screenshot'

@Component({
  selector: 'nwb-items-ext-page',
  templateUrl: './items-ext-page.component.html',
...
export class ItemsExtPageComponent {
  protected title = 'Items (Extended)'
  protected filterParam = 'filter'
  protected selectionParam = 'id'
  protected persistKey = 'items-ext-table'
  ...
  public constructor(
    ...
    head.updateMetadata({
      url: head.currentUrl,
      title: 'New World - Items DB (Extended)',
    })
  }
}